...
.. image:: {static}/images/person/generic.jpg
   :name: luisHenriqueCarnevaleCunha_face
   :width: 25%
   :alt: luisHenriqueCarnevaleCunha
   :align: left

Luis Henrique Carnevale da Cunha was an undergraduate scientific research student at `Polytechnic School`_/`UFRJ`_ under the supervision of `Prof. Gustavo R. Anjos`_. The project, *Finite Element Method for Cooling Electronic Components*, is associated with LabMFA research in computational mechanics, fluid dynamics, heat transfer, and numerical methods.
...
**academic info**:
 ...
 - Project: *Finite Element Method for Cooling Electronic Components*
 - Year: 2019
