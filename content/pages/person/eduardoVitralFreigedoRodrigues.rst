...
.. image:: {static}/images/person/generic.jpg
   :name: eduardoVitralFreigedoRodrigues_face
   :width: 25%
   :alt: eduardoVitralFreigedoRodrigues
   :align: left

Eduardo Vitral Freigedo Rodrigues was an M.Sc. student at `UERJ`_/`Gesar`_,
supervised by `Prof. Gustavo R. Anjos`_ and co-supervised by `Prof. José
Pontes`_. The project, Nano-Patterning of Surfaces by Ion Sputtering –
Numerical Study of the Anisotropic Damped Kuramoto–Sivashinsky Equation, is
associated with LabMFA research in computational mechanics, finite difference
methods, fluid dynamics, heat transfer, and numerical methods.
...
**academic info**:
 ...
 - M.Sc. at `UERJ`_/`Gesar`_
 - Project: *Nano-Patterning of Surfaces by Ion Sputtering - Numerical Study of the Anisotropic Damped Kuramoto–Sivashinsky Equation*
 - Year: 2015
 - Advisors: `Prof. Gustavo R. Anjos`_ and `Prof. José Pontes`_
...
.. _Prof. José Pontes: https://www.gesar.uerj.br/equipe/equipe-gesar.html
